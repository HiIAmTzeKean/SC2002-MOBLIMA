...
public class Showtime implements IBooking, Serializable {
	...
	/**
	 * Prints the movie object composited in class.
	 */
	...
	/**
	 * Prints cinema layout composited in class.
	 */
	...
	/**
	 * Prints the cineplex linked to the cinema composited
	 */
	...
	public void changeDay(IDay day) throws IllegalArgumentException {
		if (day == null)
			throw new IllegalArgumentException("Day object null");
		this.day = day;
	}
	...
	@Override
	public float getPrice(Customer customer, boolean isCoupleSeat, String discountCodeTicket)
			throws IllegalArgumentException, CustomerNullException {
		if (isCoupleSeat) {
	 ...
	 */
	@Override
	public float getPrice(Customer customer, boolean isCoupleSeat)
			throws IllegalArgumentException, CustomerNullException {
		if (isCoupleSeat)
