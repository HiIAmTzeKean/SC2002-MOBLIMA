...
public interface ICineplex {
	...
	/**
	 * Function to create new cineplex object
	 * 
	 * @param name
	 * @param location
	...
	/**
	 * Deletes an existing cineplex
	 * 
	 * @param CineplexID
	 * @throws IllegalArgumentException if cineplex not found
	 */
	...
	/**
	 * Prints all cineplex in admin view for staff
	 * 
	 */
	void printCineplexesAdmin();

	/**
	 * Prints all cinema under a target cineplex
	 * 
	 * @param cineplexID
	 */
